		...
		setTimeout( function( ){ 
			...
			if( !root.isCorrect ){
				if( root.waitCorrectButton ){
					...
					BoxDragQuestion.prototype.toggleWrong.call( root, false );
				}
				else{
					BoxDragQuestion.prototype.handleWrong.call( root );
				}
...
BoxDragQuestion.prototype.handleWrong = function( ){
	...
	BoxDragQuestion.prototype.toggleWrong.call( this, true );
...
BoxDragQuestion.prototype.toggleWrong = function( show ){
	console.debug( "toggleWrong" );
	if( show ){
